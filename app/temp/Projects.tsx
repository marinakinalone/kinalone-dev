  ...
  return (
    <section className="projects" id="projects">
      <div className="projects__highlighted">
        <a
          className="projects__card sub-containers"
          href={'https://github.com/marinakinalone/garden-js'}
          target="_blank"
        ...
        >
          ...
          <h3>Garden JS</h3>
          <p>
            A cute game to practice JavaScript. Built with React, Redux, SASS Node, Express and
            MongoDB.
          </p>
        </a>
        <a
          className="projects__card sub-containers"
          href="https://le-voyage-a-stockholm.onrender.com/"
          target="_blank"
          rel="noopener noreferrer"
        >
          ...
          <p>
            My favorite places in Stockholm, on a map. Built with React, Sass, Node, Express and the
            Google Maps API.
          </p>
        </a>
        <a
          className="projects__card sub-containers"
          href="https://la-la-dance.vercel.app/"
          target="_blank"
          rel="noopener noreferrer"
        >
          ...
          <h3>La La Dance</h3>
          <p>
            A personnality test to find the social dance type that suits us best. Built with React
            and React Bootstrap.
          </p>
        </a>
        <a
          className="projects__card sub-containers"
          href="https://sailor-moon-quote-machine.vercel.app/"
          target="_blank"
          rel="noopener noreferrer"
        >
          ...
          <p>
            A sailormoon-themed random quote machine. My first React project. Built with React and
            Sass.
          </p>
        </a>
      </div>
