  ...
  return (
    <section className="projects" id="projects">
      ...
      <div className="projects__highlighted">
        <a className="projects__card sub-containers" href={"https://github.com/marinakinalone/garden-js"} target="_blank" rel="noopener noreferrer">
        ...
        <a className="projects__card sub-containers" href="https://le-voyage-a-stockholm.onrender.com/" target="_blank" rel="noopener noreferrer">
        ...
        <a className="projects__card sub-containers" href="https://la-la-dance.vercel.app/" target="_blank" rel="noopener noreferrer">
