...
const Intro = () => {
  ...
  const toggleHover = (e:any) => e.target.style.color = "#287773"
  return (
    <section className="intro">
      ...
      <div className="intro__content sub-containers">
        ...
        <p className="intro__copyright">p.s.: drawing is from <a className="link-regular" href="https://www.instagram.com/lulu.xalo/" target="_blank" rel="noopener noreferrer" onMouseOver={toggleHover} >amazing artist Lu Lo</a></p>
      </div>
  </section>
  )
}
